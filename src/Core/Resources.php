...
final class Resources
{
    ...
    public const DIR_ROOT = __DIR__.'/../../res/';

    public const DIR_SCHEMA = __DIR__.'/../../res/schema/';
    ...
    public const FILE_CDX_JSON_SCHEMA_1_2 = __DIR__.'/../../res/schema/bom-1.2.SNAPSHOT.schema.json';
