...
* Removed
  ...
  * Method `CycloneDX\Core\Validation\BaseValidator::getSpec()` ([#590] via [#])
* Changed
  ...
  * `CycloneDX\Core\Validation\BaseValidator::__construct()` parameter is type `CycloneDX\Core\Spec\Version` ([#590] via [#])  
